...
string max_ml_outfit = "slimeitems";
string max_ml_familiar = "dandy lion";

string min_ml_outfit = "minml";
string min_ml_familiar = "dandy lion";
...
boolean chamois()
{
	...
	string tmp = visit_url( "clan_slimetube.php?action=chamois" );
