...
boolean burn_mana = true;//set this to true if you want to burn mana.
...
void play( int bet , int rounds )
{
   ...
   while( rounds > 0 )
   {
      ...
      while(!contains_text(page, "Play Again"))
      {
         ...
         {//if !soft
            ...
            else if(my_sum == 6)
            {
               ...
               else if(opp == "4" && my_cards[1] == "4")
               {//opp is 4 and our hand is "2 4"
                  page = double();
                  double= true;
               }
               else
                  ...
                  else
                  {
                     ...
                     if(opp == "2")
                     {
                        if(   (my_cards[0] == "2" && my_cards[1] == "2" && my_cards[2] == "4") 
                           ...
                           || (my_cards[0] == "a" && my_cards[1] == "3" && my_cards[2] == "4"))
                        {
                           page = stand();
                        }
                        else
                     ...
                     else if(opp == "3")
                     {
                        if(   (my_cards[0] == "2" && my_cards[1] == "2" && my_cards[2] == "4") 
                           ...
                           || (my_cards[0] == "a" && my_cards[1] == "3" && my_cards[2] == "4")
                           || (my_cards[0] == "a" && my_cards[1] == "2" && my_cards[2] == "5")
                  ...
                  else
                  {
                     ...
                     if(opp == "a")
                     {
                        if(   (my_cards[0] == "a" && my_cards[1] == "4" && my_cards[2] == "4") 
                           || (my_cards[0] == "2" && my_cards[1] == "3" && my_cards[2] == "4")
                           || (my_cards[0] == "2" && my_cards[1] == "2" && my_cards[2] == "5"))
                        {
                           page = stand();
                        }
                        else
	...
	int my_sum = get_my_sum(page);
	print("I have: " + my_sum);
      if(contains_text(page, "Push"))
      {
         print("Push","blue");
         pushbets = pushbets + 1;
      }
      else if(contains_text( page, "You acquire"))
      {
         string winbux = substring(page,index_of(page,"You acquire ")+15,
            index_of(page,"Crimbu",last_index_of(page,"You acquire ")+1)-1);
         int roundtotal= to_int(winbux);
         total = total + roundtotal - bet;
         print("You Win!", "green");
         winbets = winbets + 1;
      }
      else
   ...
   print("Wins: " + winbets,"green");
   print("Losses: " + losebets,"red");
   print("Pushes: " + pushbets,"blue");
   float avg;
   if(winbets+losebets+pushbets>0)
   {
   ...
   if(total>0)
   {
      print("Grand Total: " + total + "(" + avg + "/adv)","green");
   }
   else if(total<0)
   {
      print("Grand Total: " + total+ "(" + avg + "/adv)","red");
   }
   else
   {
      print("Grand Total: 0? What's the point?","blue");
   }
}
